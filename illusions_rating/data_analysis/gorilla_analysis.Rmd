...
# save as pdf
pdf(file = paste0(figures_path, "orientiation.pdf"),   # The directory you want to save the file in
    width = 8, # The width of the plot in inches
    height = 5) #
...
# Sex
# my_plot =
hist(demographics_df$Sex, xlab = "Sex", main = "")

unique(demographics_df$Sex)
