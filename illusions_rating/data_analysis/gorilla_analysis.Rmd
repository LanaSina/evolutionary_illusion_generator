...
for (id in unique(ids$illusion_id)){
  ...
  median = c(median, median(sub$strength))
  sd = c(sd, sd(sub$strength))
}
...
plot(ill_ave$id, ill_ave$mean_strength, xaxt="n", ylim = c(0, 5), 
     xlab = "", ylab = "Strength")
points(ill_ave$id, ill_ave$median_strength, col = "grey")
...
# median with sd 
n = length(ill_ave$name)
plot(ill_ave$id, ill_ave$median_strength, xaxt="n", ylim = c(0, 5), 
     xlab = "", ylab = "Median Strength")
# error bars: we draw arrows but with very special "arrowheads"
arrows(ill_ave$id, ill_ave$median_strength-ill_ave$sd,
       ill_ave$id, ill_ave$median_strength+ill_ave$sd, length=0.05, angle=90, code=3)
...
plot(ill_ave$id, ill_ave$mean_strength, xaxt="n", ylim = c(0, 5), 
     xlab = "", ylab = "Median Strength")
# error bars: we draw arrows but with very special "arrowheads"
arrows(ill_ave$id, ill_ave$mean_strength-ill_ave$sd,
       ill_ave$id, ill_ave$mean_strength+ill_ave$sd, length=0.05, angle=90, code=3)
